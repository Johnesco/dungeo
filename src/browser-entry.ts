/**
 * Browser Entry Point for A faithful Sharpee port of the 1981 Mainframe Zork. 172 rooms, 716 max score.
 *
...
async function start(): Promise<void> {
  console.log('=== A faithful Sharpee port of the 1981 Mainframe Zork. 172 rooms, 716 max score. BROWSER START ===');
